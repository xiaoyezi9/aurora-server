...
exports.upload = (req, res) => {
    const file = req.file
    file.url = `http://localhost:8000/uplodes/${file.filename}`
    console.log(file)
    res.send(file)
}
/**
...
exports.joinslist = async (req, res) => {
    let info = [req.user.uid]
    let sql = 'select * from joins,activity where activity.activity_id=joins.content_id and joins.user_id=?'
...
exports.createfankui = async (req, res) => {
    ...
    let info = {
        ...
        fankui_user: req.body.fankui_user,//  用户邮箱
...
exports.createjubao = async (req, res) => {
    ...
    let info = {
        ...
        jubao_user: req.body.jubao_user,//  用户id
